// Generated by Wrangler by running `wrangler types` (hash: e91f3534cfc8278532cf74163cac1ef5)
// Runtime types generated with workerd@1.20250409.0 2025-04-04 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		SCOPES: string;
		TEST_DURABLE_OBJECT: DurableObjectNamespace<import("./workers/app").TestDurableObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "SHOPIFY_APP_HANDLE" | "SHOPIFY_APP_URL" | "SHOPIFY_API_KEY" | "SHOPIFY_API_SECRET" | "SCOPES">> {}
}
